// Jena Lovejoy
// BuildSite takes in the ArrayList of words generated by BuildDictionary and a basic HTML file, 
// and generates a new HTML file with those words as colors
...
public class BuildSite {
    ...
    // Parses the starting HTML file and the ArrayList, then combines the two
    ...
    // Takes the new HTML as a string and writes it to a file to be used
